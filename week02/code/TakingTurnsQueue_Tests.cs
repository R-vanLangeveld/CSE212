...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected "Bob" got "Sue", Enqueue was adding to the start of the queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Expected "Tim" got "Sue", GetNextPerson() had no code for if person.Turns was less than 1
